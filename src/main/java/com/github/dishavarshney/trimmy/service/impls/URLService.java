...
//
//    public boolean addURLDocument(URLDocument entity) {
...
//        }
//        List<URLDocument> lURL = uRLRepository.findByUrlHashCodeAndCreatedBy(hashCode, lUser.getUsername());
//        if (!lURL.isEmpty()) {
//            addRandom = true;
//            for (URLDocument URLDocument : lURL) {
//                if (URLDocument.getUrl().equals(entity.getUrl())) {
//                    return false;
//                }
//            }
//        }
...
////        List<URLDocument> expiredURLs = uRLRepository.findByExpirationDateBefore(currentDate);
...
////    }
//
//    public boolean deleteURLDocument(String id) {
//        uRLRepository.deleteById(id);
//        return true;
//    }
//
//    public Optional<URLDocument> getURLDocument(String key) {
